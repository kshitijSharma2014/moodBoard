...
var expTable = $('#exportTable').DataTable({
    ...
    "columns": [
        ...
        },
        {
            "data": "filename",
            "render": function (data, type, row, meta) {
                return '<div value=' + row.filename + ' class="filename">'+row.filename+'</div>';
            }
        },
        {
            "data": "sheetname",
            "render": function (data, type, row, meta) {
                return '<div value=' + row.sheetname + '>' + row.sheetname + '</div>';
            }
        },
     
        {
            "data": "totalrecords",
            "render": function (data, type, row, meta) {
                return '<div>' + row.totalrecords + '</div>';
            }
        },
        {
            "data": "verified",
        ...
        {
            "render": function (data, type, row, meta) {
                // TODO add class exportTblEdit to css file.
                return '<img src="/Areas/Admin/images/editRow.png" class="exportTblEdit" style="width: 14px;cursor:pointer;" id=' + row.ijobcode + '/>';
            }
        },
    ],
});
...
$('#exportTable').on('click', 'tbody .exportTblEdit', function () {
